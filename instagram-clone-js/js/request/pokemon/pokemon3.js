...
// 목록을 비우지 않고 뒤에 붙임. 이름만 있는 목록은 각자 url을 동시에 다시 요청
...
// 한 페이지 받아 붙인 뒤, 다음 요청을 위해 offset을 밀어 둠
...
// 스피너가 화면에 보이면 다음 페이지. next가 없으면 감시 끊음
...
// 첫 getPokemon()은 안 부름. 스피너가 보이면 옵저버가 첫 요청을 함
// getPokemon();